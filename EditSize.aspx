      ...
      <div class="panel-body">
          <div class="row">
               ...
               <div class="col-sm-6">
                ...
                <div class="row">
                <div class="col-md-12">
                <h4 class="alert-info text-center"> All Sizes</h4>
                <br />
                 <asp:TextBox ID="txtFilterGrid1Record" style="border:2px solid blue" CssClass="form-control" runat="server" placeholder="Search Size...." onkeyup="Search_Gridview(this)"></asp:TextBox>
                <hr />
