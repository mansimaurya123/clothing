...
<br /><br /><br />
      ...
      <div class="panel-body">    
           ...
           <div class="row">
               ...
               <div class="form-group">
               <label>SelectSub Category:</label>
        ...
        <div class="row">
                <div class="col-md-12">
                <h4 class="alert-info text-center"> All Sub-Categories</h4>
                <br />
                 <asp:TextBox ID="txtFilterGrid1Record" style="border:2px solid mediumorchid" CssClass="form-control" runat="server" placeholder="Search Sub-Category...." onkeyup="Search_Gridview(this)"></asp:TextBox>
                <hr />
