...
<div class="container">
  ...
  <br />
    ...
    <div class="panel panel-primary">
      <div class="panel-heading"><h2>Product Sell Reports</h2>  </div>
      ...
      <div class="panel-footer">
       <div class="panel-heading"><h2> Quantity Report</h2>  </div>
      <div class="panel-body">
          <div class="row">
             <div class="col-md-12">
                <div class="table-responsive">
                    <asp:GridView ID="GridView2" runat="server" CssClass="table table-condensed table-hover" href="" >
                    </asp:GridView>
