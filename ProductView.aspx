...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="item <%# GetActiveImgClass(Container.ItemIndex) %>">
      <img src="img/ProjectImages/<%# Eval("PID") %>/<%# Eval ("Name") %><%# Eval("Extension") %>" alt="<%# Eval ("Name") %>" alt="...">
    ...
    <span class="sr-only">Next</span>
        ...
        <div class="col-md-5">
            ...
            <div class="divDet1">
                ...
                <span class="proOgPriceView"><%#Eval("PPrice","{0:c}") %></span><span class="proPriceDiscountView">(₹.<%# string.Format("{0}",Convert.ToInt64(Eval("PPrice"))-Convert.ToInt64(Eval("PSellPrice"))) %>Off)</span><p class="proPriceView">Rs. <%#Eval("PSellPrice","{0:c}") %></p>
            </div>
            <div >
            ...
            <div >
                ...
                <p><%# ((int)Eval("7DayRet")==1)? "7 Days Returns":""  %></p>
