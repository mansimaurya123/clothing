...
public partial class EditSize : System.Web.UI.Page
{
    ...
    {
        SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["ClothingDB"].ConnectionString);
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            SubCID = ds.Tables[0].Rows[0]["SubCatID"].ToString();
            subcategory();
            ddlSubCategory.SelectedValue = SubCID;

            GenderID = ds.Tables[0].Rows[0]["SubCatID"].ToString();
            BindGender();
